...
<body class="font-barlow bg-slate min-h-screen flex items-stretch overflow-hidden">
    ...
    <!-- ═══════════════════ LOGIN PAGE ═══════════════════ -->
    <div id="loginPage" style="display:contents;">

        <!-- LEFT – warehouse photo -->
        <div class="flex-[1.1] relative overflow-hidden hidden md:flex flex-col justify-end">

            <!-- Background image with zoom animation -->
            <div class="warehouse-vignette absolute inset-0 bg-cover bg-center animate-slowZoom"
                 style="background-image:url('https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&q=80&fit=crop');"></div>
            ...
            <div class="relative z-20 p-12">
                ...
                <!-- Badge -->
                <div class="inline-flex items-center gap-2 bg-amber/15 border border-amber/40 rounded px-3.5 py-1.5
                            text-amber font-condensed text-xs font-bold tracking-widest uppercase mb-5">
                    <i class="fas fa-warehouse"></i>
                    Warehouse Management System
                </div>

                <!-- Headline -->
                <h1 class="font-condensed font-extrabold leading-none tracking-tight text-snow mb-4"
                    style="font-size: clamp(38px, 4vw, 64px);">
                    KRA / <span class="text-amber">KPI</span><br>Portal
                </h1>

                <!-- Sub-text -->
                <p class="text-[15px] text-muted font-light leading-relaxed max-w-sm mb-10">
                    Compass Business Management — track performance, manage operations,
                    and keep your floor running at peak efficiency.
                </p>

                <!-- Stats row -->
                <div class="flex gap-8">
                    <div>
                        <div class="font-condensed text-[28px] font-bold text-amber leading-none">99.8%</div>
                        <div class="text-[11px] text-muted uppercase tracking-widest mt-1">Uptime</div>
                    </div>
                    <div>
                        <div class="font-condensed text-[28px] font-bold text-amber leading-none">24/7</div>
                        <div class="text-[11px] text-muted uppercase tracking-widest mt-1">Monitoring</div>
                    </div>
                    <div>
                        <div class="font-condensed text-[28px] font-bold text-amber leading-none">256-bit</div>
                        <div class="text-[11px] text-muted uppercase tracking-widest mt-1">Encryption</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- RIGHT – login form -->
        <div class="right-panel-accent w-full md:w-[440px] md:min-w-[380px] bg-slate flex flex-col justify-center
                    px-7 py-10 sm:px-12 sm:py-14 relative z-30">
            ...
            <!-- Form header -->
            <div class="mb-8">
                <h2 class="font-condensed text-[30px] font-bold text-snow tracking-tight mb-1.5">Welcome Back</h2>
                <p class="text-muted text-sm">Enter your credentials to access the portal</p>
            </div>
            ...
            <form id="loginForm">
                ...
                <div class="relative mb-5">
                    <label class="block text-[11px] font-semibold tracking-widest uppercase text-muted mb-2"
                           for="email">Email Address</label>
                    <i class="fas fa-envelope absolute left-3.5 top-[68%] -translate-y-1/2 text-steel-lt text-sm z-10 pointer-events-none"></i>
                    <input type="email" id="email"
                           class="w-full bg-steel border border-steel-md rounded-md py-3 pl-10 pr-3.5 text-sm
                                  font-barlow text-snow placeholder-steel-lt outline-none transition
                ...
                <div class="relative mb-5">
                    ...
                    <i class="fas fa-building absolute left-3.5 top-[68%] -translate-y-1/2 text-steel-lt text-sm z-10 pointer-events-none"></i>
                ...
                <div class="relative mb-5">
                    ...
                    <i class="fas fa-lock absolute left-3.5 top-[68%] -translate-y-1/2 text-steel-lt text-sm z-10 pointer-events-none"></i>
                    <input type="password" name="password" id="password"
                           class="w-full bg-steel border border-steel-md rounded-md py-3 pl-10 pr-10 text-sm
                                  font-barlow text-snow placeholder-steel-lt outline-none transition
                                  focus:border-amber focus:ring-2 focus:ring-amber/20"
                           placeholder="Enter your password" required>
                    <button type="button" id="togglePassword"
                            class="absolute right-3.5 top-1/2 -translate-y-1/2 bg-transparent border-0
                                   text-steel-lt text-sm z-10 cursor-pointer transition hover:text-amber p-0">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="rememberMe"
                               class="rounded border-steel-md bg-steel text-amber focus:ring-amber/30 cursor-pointer">
                        <label for="rememberMe" class="text-muted text-[13px] cursor-pointer">Remember me</label>
                    </div>
                    <a href="/Forgot.php"
                ...
                <button type="submit" id="loginBtn"
                        class="w-full flex items-center justify-center gap-2 py-3.5 border-0 rounded-md
                ...
                <button type="button" id="installBtn"
                        class="hidden w-full flex items-center justify-center gap-2 mt-3 py-2.5
                               border border-steel-md rounded-md bg-transparent text-muted font-condensed
                               text-sm font-semibold tracking-wider uppercase cursor-pointer transition
                               hover:border-amber hover:text-amber">
                    <i class="fas fa-download"></i> Install App (PWA)
                </button>
                <div id="installStatus" class="text-muted text-xs text-center mt-2"></div>
                ...
                <form id="otpForm">
                    ...
                    <div class="flex gap-2.5 justify-center my-7">
                        <input type="number" class="otp-input w-[52px] h-[56px] text-center text-[22px] font-bold
                               ...
                               transition focus:border-amber focus:ring-2 focus:ring-amber/20"
                    ...
                    <button type="submit" id="verifyBtn"
                            class="w-full flex items-center justify-center gap-2 mt-6 py-3.5 border-0 rounded-md
                                   bg-gradient-to-br from-amber to-amber-dk text-slate font-condensed text-base
                                   font-bold tracking-widest uppercase cursor-pointer transition
                                   hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(245,158,11,0.35)]
                                   active:translate-y-0">
    ...
    <style>
        .alert-success { background: rgba(34,197,94,.15);  color: #4ADE80; border-radius: 6px; padding: 10px 14px; margin-bottom: 16px; font-size: 13px; }
        .alert-danger  { background: rgba(239,68,68,.15);  color: #FCA5A5; border-radius: 6px; padding: 10px 14px; margin-bottom: 16px; font-size: 13px; }
        .alert-warning { background: rgba(245,158,11,.15); color: #FCD34D; border-radius: 6px; padding: 10px 14px; margin-bottom: 16px; font-size: 13px; }
        .alert-info    { background: rgba(99,102,241,.15); color: #A5B4FC; border-radius: 6px; padding: 10px 14px; margin-bottom: 16px; font-size: 13px; }
    </style>
            ...
            $.ajax({
                ...
                data: {
                    logindata: JSON.stringify({
                        ...
                        company: company,
                        password: password,
                        domainname: '<?php echo $domain = preg_replace("/www\./i", "", $_SERVER["SERVER_NAME"]); ?>'
                    })
                },
                dataType: "json",
                success: function (response) {
                    if (response.success === true) {
                        ...
                        showOtp();
                        showAlert('✓ Login successful! Please enter the OTP sent to your email.', 'success');
                        startCountdown();
                    } else {
                        showAlert('⚠ ' + response.message, 'danger', 'alertContainerLogin');
                    }
        ...
        document.getElementById('otpForm').addEventListener('submit', function (e) {
            ...
            if (otp.length === 6) {
                ...
                $.ajax({
                    type: "POST",
                    url: "commonfunc.php",
                    data: { otpverify: JSON.stringify({ action: 'verify_otp', otp: otp }) },
                    headers: { 'X-CSRF-Token': '', 'X-Requested-With': 'XMLHttpRequest' },
                    dataType: "json",
                    success: function (response) {
                        if (response.success === true) {
